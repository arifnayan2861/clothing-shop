  ...
  return (
    <section className="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 bg-white">
      <div className="container mx-auto px-4 bg-white">
        <div className="lg:col-gap-12 xl:col-gap-16 mt-8 grid grid-cols-1 gap-12 lg:mt-12 lg:grid-cols-5 lg:gap-16 bg-white">
          <div className="lg:col-span-3 lg:row-end-1 bg-white">
            <div className="lg:flex lg:items-start bg-white">
              <div className="lg:order-2 lg:ml-5 bg-white">
                <div className="max-w-xl overflow-hidden rounded-lg bg-white">
                  <img
                    src={item.imageUrl}
          ...
          <div className="lg:col-span-2 lg:row-span-2 lg:row-end-2">
            ...
            <div className="lg:col-span-3">
              ...
              <div className="mt-8 flow-root sm:mt-12 text-gray-900">
